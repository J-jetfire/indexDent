   ...
   <div class="container main_profile_3">
      ...
      <div class="col1" id="left_profile_block_3">
         ...
         <div class="row patient_info_3">
            ...
            <a href="users.php" style="text-decoration:none;"><h4 class="h4blue_3">&bull; Пользователи</h4></a>
        ...
        <div class="this_container" id="modal_this_container">
            <form action="index3.php" method="post">
               <table class="table_of_new">
                  <thead>
                     <tr>
                        <th colspan="2">Добавить нового пользователя</th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
                     ...
                     <tr>
                        <td class="this_names">Email:</td>
                        <td><input type="text" name="email" placeholder="" required></td>
                     </tr>
                     <tr>
                        <td class="this_names">Роль:</td>
                        <td>
                           <select name="role" id="select_modal">
                     ...
                     <tr>
                        <td class="this_names">Организация:</td>
                        <td>
                           <select name="org" id="select_modal">
                     ...
                     <tr>
                        <td colspan="2"><input type="submit" class="blue_button" value="Добавить пользователя"></td>
                     </tr>
                  </tbody>
               </table>
            </form>
        ...
        <div class="this_container" id="modal_this_container">
            <form action="index3.php" method="post">
               <table class="table_of_new">
                  <thead>
                     <tr>
                        <th colspan="2">Редактировать пользователя</th>
                     </tr>
                  </thead>
                  <tbody>
                     <tr>
