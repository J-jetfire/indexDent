   ...
   <div class="container main_profile_3">
      ...
      <div class="col1" id="left_profile_block_3">
         ...
         <div class="row patient_info_3">
            ...
            <a href="reports.php" style="text-decoration:none;"><h4 class="h4blue_3">&bull; Отчеты</h4></a>
               ...
               <table class="table_of_shots_3 paginated" id="table_of_shots">
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td><a href="#" class="link_to">11</a></td>
                        <td><input type="checkbox" id="check_1" class="custom-checkbox"><label for="check_1"></label></td>
                        <td><input type="checkbox" id="check_2" class="custom-checkbox"><label for="check_2"></label></td>
                        <td><input type="checkbox" id="check_3" class="custom-checkbox"><label for="check_3"></label></td>
                        <td>2020-06-22 08:08:04</td>
                        <td style="padding:0;"><img src="img/icons/eye_ico_on.svg" alt="" data-id="1" class="table_ico2"></td>
                     ...
                     <tr>
                        ...
                        <td>email@email.com</td>
                        <td><a href="#" class="link_to">11</a></td>
                        <td><input type="checkbox" id="check_4" class="custom-checkbox"><label for="check_4"></label></td>
                        <td><input type="checkbox" id="check_5" class="custom-checkbox"><label for="check_5"></label></td>
                        <td><input type="checkbox" id="check_6" class="custom-checkbox"><label for="check_6"></label></td>
                        <td>2020-06-22 08:08:04</td>
                        <td style="padding:0;"><img src="img/icons/eye_ico_on.svg" alt="" data-id="2" class="table_ico2"></td>
