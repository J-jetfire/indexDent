...
<nav class="navbar navbar-expand-lg">
   <div class="container-fluid">
      ...
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-main" aria-controls="navbar-main" aria-expanded="true">
   ...
   <div class="container main_block">
      <div class="row block_1">
         <div class="col-xs-7 left-col-1">
            ...
            <div class="row">
               <h1 id="d_violet" class="second_topic">По вашему запросу DIANA...</h1>
            ...
            <div class="row">
               <h1 id="l_violet" class="third_topic">DIANA помогает сделать профилактику<br>в стоматологии точной и эффективной!</h1>
            </div>
         </div>
         <div class="col-xs-5 image_col">
            <div class="row right-col-1">
               <img src="img/tooth.svg" alt="" id="tooth_logo">
            </div>
            <div class="row" id="link">
               <a href="#">
                  <h4 class="link_to_bot"><a href="#block4">ПОПРОБОВАТЬ<img src="img/icons/arrow_down.svg" alt="" id="arrows"></a></h4>
               </a>
            </div>
         </div>
      </div>
      ...
      <div class="row block_2">
         <div class="row line_first"><a id="block2"></a><h4 class="link_to_bot2"><a href="#block4">ПОПРОБОВАТЬ<img src="img/icons/arrow_down.svg" alt="" id="arrows"></a></h4></div>
         <div class="row whiteback" style="">
            <div class="col-xs-6 left-col-2">
               <h1 id="d_violet">DIANA может помочь:</h1>
            ...
            <div class="col-xs-6 right-col-2">
               <h1 id="l_violet">DIANA может быть полезна:</h1>
      ...
      <div class="row block_4">
         ...
         <div class="row whiteback" style="height:auto;">
            ...
            <div class="row">
               <h2 class="try_out"><a href="#top">В НАЧАЛО<img src="img/icons/arrow_up.svg" alt="" id="arrows"></a></h2>
            </div>
         </div>

         <div class="row footer">
            <div class="row" style="width:90%;margin:0 auto;">
               <p class="text_foot">Assisted by DIANA™ - Dental Index Analysis Application | <span><a href="#block4">Файлы cookie</a></span> | <span><a href="#block4">Политика конфиденциальности</a></span> | <span><a href="#block4">Правила использования</a></span><br>Результаты расчета не являются диагнозом или медицинской рекомендацией и не заменяют консультации с врачом.</p>
            </div>
         </div>
